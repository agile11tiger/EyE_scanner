...
namespace VerificationCheck.Core.Resources
{
    internal static class Urls
    {
        ...
        internal static string GetCheckUrl(string fiscalNumber, string fiscalDocument, string fiscalSign, DateTime date, double sum)
        {
